...
CFLAGS := -m64 -Wall -Wextra -g3  -ffreestanding -nostdinc -nostdlib -fno-stack-protector -fshort-wchar -mno-red-zone -fno-builtin
FLAGS_NOEXCEPTION := -fno-exceptions -fno-unwind-tables
OBJCP:= objcopy
QEMU := qemu-system-x86_64
QEMU_FLAGS :=  -m 4G -gdb tcp::10000 -S -cpu qemu64

SRC:= main.cpp efi.cpp common.cpp string.cpp shell.cpp graphics.cpp gui.cpp file.cpp
